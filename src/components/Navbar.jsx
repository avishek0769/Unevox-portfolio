...
import { Menu, X, PhoneCall, Package } from 'lucide-react';
...
export default function Navbar({ onBookCall }) {
  ...
  return (
    <>
      <nav className="sticky top-0 z-40 bg-white border-b border-[#e2dbd3] shadow-sm py-1">
        <div className="max-w-7xl mx-auto px-6 md:px-8 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            <button
              ...
              className="px-5 py-2.5 rounded-full border border-[#e95f0c]/40 text-[#e95f0c] font-display font-bold text-sm hover:bg-[#e95f0c]/5 transition-all duration-200 cursor-pointer"
            >
              Customize Package
            </button>
            <button
          ...
          <div className="lg:hidden flex items-center gap-2">
            <button
              onClick={() => setIsCustomizeOpen(true)}
              className="p-2 rounded-full bg-[#e95f0c]/10 text-[#e95f0c] hover:bg-[#e95f0c]/20 transition-colors"
        ...
        >
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="pt-5 mt-4 border-t border-[#e2dbd3] flex flex-col gap-3">
              <button
                onClick={() => { setIsOpen(false); setIsCustomizeOpen(true); }}
                className="w-full py-3 rounded-full border border-[#e95f0c]/40 text-[#e95f0c] font-display font-bold text-sm hover:bg-[#e95f0c]/5 transition-all duration-200 cursor-pointer"
              >
                Customize Package
              </button>
              <button
      ...
      {/* Customize Package Modal — self-contained here */}
